...
const Invoice = () => {
  return (
    <div className="container mx-auto w-[550px] mt-3">
      <header className="flex justify-between items-center">
        <h1 className="font-extrabold text-4xl">INVOICE</h1>
        <img src="#" alt="LaundryWala Logo" />
      </header>
      ...
      <main className="mt-10">
        <div className="flex justify-between mt-5">
          <div className="w-1/2">
            ...
            <p className="mt-2">Cus ID: 201</p>
            <p className="mt-2">Name: Kirtikumar Kavande</p>
          ...
          <div className="w-1/2">
            ...
            <p className="mt-2">Mukai Nagar, Hinjewadi</p>
            <p className="mt-2">Mo No. 7756951888</p>
          </div>
        </div>
        ...
        <div className="mt-5">
          <table className="w-full">
            <thead>
              <tr>
                <th className="bg-[#E6E6E8] text-gray-800 -px-2 py-1">
                  Cloth Type
                </th>
                <th className="bg-[#E6E6E8] text-gray-800 px-2 py-1">
                  Wash Type
                </th>
                <th className="bg-[#E6E6E8] text-gray-800 px-2 py-1">Qty</th>
                <th className="bg-[#E6E6E8] text-gray-800 px-2 py-1">Amount</th>
              </tr>
            </thead>
            <tbody>
              <tr className="text-center">
                <td className="px-2 py-1">Shirt</td>
                <td className="px-2 py-1">W & F</td>
                <td className="px-2 py-1">2</td>
                <td className="px-2 py-1">Rs. 100</td>
              </tr>
              <tr className="text-center">
                <td className="px-2 py-1">Pant</td>
                <td className="px-2 py-1">W & F</td>
                <td className="px-2 py-1">4</td>
                <td className="px-2 py-1">Rs. 200</td>
              </tr>
              <tr className="text-center">
                <td className="px-2 py-1">Trousers</td>
                <td className="px-2 py-1">W & F</td>
                <td className="px-2 py-1">5</td>
                <td className="px-2 py-1">Rs. 250</td>
              </tr>
            </tbody>
          </table>
        </div>

        <div className="flex  mt-4 bg-[#E6E6E8] pr-3 justify-end space-x-20 ">
