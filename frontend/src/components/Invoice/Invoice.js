...
function Invoice() {
  ...
  return (
    <div className="wrapper  ">
      <div
        className="receipt-box tracking-widest w-[900px] h-[1220px] "
              ...
              <div className="mt-5">
                <table className="w-full">
                  ...
                  <tbody>
                    ...
                    {invoiceData.isExpressDelivery && invoiceData.washType.type==="perKg"&&(
                      <tr className="text-center ">
                    ...
                    {invoiceData.isExpressDelivery && (
                      <tr className="text-center ">
                        <td className={`px-2 ${invoiceData.isExpressDelivery && invoiceData.washType.type==='perKg'?"pt-2":"pt-6" } `}>Express Charges</td>
                        <td className={`px-2 ${invoiceData.isExpressDelivery && invoiceData.washType.type==='perKg'?"pt-2":"pt-6" } pt-6`}>-</td>
                        <td className={`px-2 ${invoiceData.isExpressDelivery && invoiceData.washType.type==='perKg'?"pt-2":"pt-6" } pt-6`}>-</td>
                        <td className={`px-2 ${invoiceData.isExpressDelivery && invoiceData.washType.type==='perKg'?"pt-2":"pt-6" } pt-6`}>
                          {invoiceData?.amountForPerPeice > 0
