    ...
    <div>
      <div className="w-full flex pt-3 px-3">
        <div className="w-1/3 mb-4">
          ...
          <div>
          <input
              className="bg-gray-200 w-full appearance-none border-2 border-gray-200 rounded mr-2 py-2 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-black "
              id="inline-full-name"
              type="text"
              name="name"
      ...
      <div className=" flex  justify-center space-x-12 pb-5 ">
        <button className="bg-white hover:bg-blue-500 text-black font-semibold hover:text-white py-2 px-6 border border-blue-500 hover:border-transparent rounded">
          Invoice
        </button>
